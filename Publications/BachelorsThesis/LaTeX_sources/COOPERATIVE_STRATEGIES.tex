...
\newcommand{\autor}{Carlos Garc\'{i}a-Saura}
\newcommand{\director}{Nombre Apellido1 Apellido2}
\newcommand{\tutor}{Pablo Varona Mart\'{i}nez}
...
\input{chapters/chap3_experiments}

\input{chapters/chap4_conclusions}
...
\input{appendix_lightLandmarkLocalization}

\input{appendix_circuits}

\input{appendix_designStrategies}
