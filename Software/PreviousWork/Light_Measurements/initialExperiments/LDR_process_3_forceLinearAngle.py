...
# Will store LDR values and angle, indexed by the distance to the light source
...
for LDR_DF in getFilesInDir(LDR_DF_PATH):
    ...
    data_all_measurements[lightDistance] = {}
    data_all_measurements[lightDistance]['vals'] = {}
    data_all_measurements[lightDistance]['angles'] = {}
    ...
    for i in range(len(LDR_real_pos)):
        ...
        data_all_measurements[lightDistance]['vals'][i] = LDR_raw[:,i]
        data_all_measurements[lightDistance]['angles'][i] = MagAngle_raw+offset
...
saveToFile_noBak(data_all_measurements,"./","data_all_measurements.p")
