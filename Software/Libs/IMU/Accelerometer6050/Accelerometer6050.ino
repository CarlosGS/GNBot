...
void loop()
{
  ...
  if(!error){
    gyr_x = 0.9*gyr_x + 0.1*((float)accel_t_gyro.value.x_gyro);
    gyr_y = 0.9*gyr_y + 0.1*((float)accel_t_gyro.value.y_gyro);
    gyr_z = 0.9*gyr_z + 0.1*((float)accel_t_gyro.value.z_gyro);
  }
  Serial.print(round(gyr_x));
  Serial.print(", ");
  Serial.print(round(gyr_y));
  Serial.print(", ");
  Serial.println(round(gyr_z));
