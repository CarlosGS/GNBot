...
ax.set_title('Comparison of a proportional yaw controller with the auto-tuned PID (I)', fontsize=18,y=1.01)
...
savefig("P_controller_vs_autotuned_PID.pdf")
savefig("P_controller_vs_autotuned_PID.png")
